...
- On exit (when simulation ends): `onexit:<action>:<object>:<extra>`
...
# Get output o1 when simulation ends
simbox -simbox-file rules.json -add "onexit:get:o1:unsigned"

# Show register r0 when simulation ends
simbox -simbox-file rules.json -add "onexit:show:r0:hex"
