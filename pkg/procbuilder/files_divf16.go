...
module {{.ModuleName}} (
  ...
  reg       [15:0] a, b, z; // [31:0] -> [15:0]
  reg       [10:0] a_m, b_m, z_m; // [23:0] -> [10:0]
  reg       [6:0] a_e, b_e, z_e; // [9:0] -> [6:0]
  reg       a_s, b_s, z_s;
  reg       guard, round_bit, sticky;
  reg       [24:0] quotient, divisor, dividend, remainder; // 10*2 + 4       (23*2) + 4
  reg       [5:0] count;
