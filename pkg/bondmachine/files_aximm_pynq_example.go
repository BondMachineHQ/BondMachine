	...
	aximmPynqExample = `
	{
		"cells": [
		 ...
		 },
		 {
		  ...
		  "source": [
		   "# PERSONALIZE HERE\n",
		   "use_preload_dataset = False\n",
		   "n_input       = 1 # number of input (features) to send for prediction\n",
		   "n_output      = 1 # number of outputs (without benchcore)\n",
		   "benchcore     = False # set to True if the BondMachine has the benchcore enabled\n",
		   "data_type     = \"lqs16t1\"\n",
		   "reg_size      = 16"
		  ]
		 },
		  ...
		  "outputs": [
		   {
			...
			"output_type": "stream",
			"text": [
			 " Starting memory address of Bondmachine IP is (in dec):  1136656384\n",
			 " Starting memory address of Bondmachine IP is (in hex):  0x43c00000\n"
			]
		   }
		  ],
		  "source": [
		 ...
		 },
		 {
		  ...
		  "outputs": [
		   {
			"data": {
			 "text/plain": [
			  "array([  3.16260499,  13.96211809, -17.1488549 ,  16.6954574 ,\n",
			  "         3.74580306,   0.41900443,   6.44675405,   4.42309091,\n",
			  "        -2.9398596 , -18.79162998])"
			 ]
			},
			"execution_count": 157,
			"metadata": {},
		  ...
		  "source": [
		   ...
		   "    X_test = np.load('banknote-authentication_X_test.npy')[:3]\n",
		   "    Y_test = np.load('banknote-authentication_y_test.npy')[:3]\n",
