...
Execute actions when the simulation ends.
...
**Use cases:**
- Retrieve final results from the simulation
- Display final register or memory states
- Collect output values after simulation completion
...
onrecv:get:io_input:signed
onrecv:show:r2
onexit:get:r3:unsigned
onexit:show:io_output:hex
config:show_ticks
```
...
simbox.Add("onexit:get:r4:unsigned")
...
| On Exit | `onexit:<action>:<object>:<extra>` | `onexit:get:r4:unsigned` |
